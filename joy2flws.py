...
def Log(event_type):
	SendClickKeyEvent(event_type, 'xlog', 'yauto', [False])
def Voice(event_type):
	SendClickKeyEvent(event_type, 'xvoice', 'yauto', [False])
def QuickLoad(event_type):
	SendClickKeyEvent(event_type, 'xqload','yauto', [False])
def QuickSave(event_type):
	SendClickKeyEvent(event_type, 'xqsave','yauto', [False])
def Load(event_type):
